          ...
          <div className="grid md:grid-cols-5 gap-0">
            ...
            <div className="md:col-span-2 bg-black p-8 md:p-12 flex flex-col justify-between">
              <div>
                ...
                <h1 className="text-6xl md:text-7xl font-black text-white mb-4 leading-tight" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  NAILS
                  <br />
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-bold" style={{ fontFamily: 'Rubik, sans-serif' }}>Работаем до 22:00</p>
                      <p className="text-gray-500 text-xs">Ежедневно без выходных</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-bold" style={{ fontFamily: 'Rubik, sans-serif' }}>Центр города</p>
                      <p className="text-gray-500 text-xs">5 мин от метро</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="md:col-span-3 p-8">
              <div className="grid grid-cols-2 gap-6 h-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl p-6 text-center text-white">
                    <Icon name="Award" size={32} className="mx-auto mb-3" />
                    <p className="text-white font-bold text-lg mb-2" style={{ fontFamily: 'Rubik, sans-serif' }}>Мастер года</p>
                    <p className="text-purple-200 text-sm">Лучший специалист 2024</p>
                  </div>
                </div>

                <div className="space-y-6">
                  <div className="bg-black rounded-2xl p-6 text-center text-white">
                    <p className="text-6xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-rose-400" style={{ fontFamily: 'Montserrat, sans-serif' }}>20%</p>
                    <p className="text-gray-300 font-bold mb-3" style={{ fontFamily: 'Rubik, sans-serif' }}>За друга</p>
                ...
                <div className="col-span-2">
                  <div className="relative group overflow-hidden rounded-2xl h-48">
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-600/60 to-transparent z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <img 
                    ...
                    />
                    <div className="absolute top-1/2 left-8 -translate-y-1/2 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      <p className="text-white text-3xl font-bold mb-1" style={{ fontFamily: 'Montserrat, sans-serif' }}>Бордо + золото</p>
                      <p className="text-gray-300">Элитный дизайн</p>
                    </div>
                  </div>
                </div>
              </div>
